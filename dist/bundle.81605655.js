...
function () {
  ...
  _createClass(SnakePlayer, [{
    key: "enemySnake",
    value: function enemySnake() {
      return [{
        x: this.x,
        y: this.y,
        enemyId: this.id,
...
},{}],"gameEffects.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(GFX, null, [{
    key: "neonTFX",
    value: function neonTFX(score, pos) {
      console.log(pos);
      var gameBox = document.querySelector("#gameBox");

      var _efx = document.createElement("div");
...
var gameEffects_1 = __importDefault(require("./gameEffects"));
...
function () {
  function Snake(sn) {
    ...
    this.socket.on("apple", function (a) {
      _this.apple = a.apple;
      _this.specialBite = a.specialBite;
    });
  ...
  _createClass(Snake, [{
    ...
    value: function draw() {
      ...
      for (var i = 0; i < this.snake.length; i += 1) {
        ...
        this.setComboStyle(s.comboFX, s, snakeLength); // this.setComboFX(this.snake);
      } ///////////////
    ...
    value: function tick() {
      ...
      for (var i = this.snake.length - 1; i >= 0; i--) {
        if (i == 0 && this.snake[i].x === this.apple.x && this.snake[i].y === this.apple.y) {
          this.snake.push({});
          this.score++;
          this.lastApplePosition = {
            x: this.apple.x,
            y: this.apple.y
          };
          gameEffects_1.default.neonTFX(this.score.toString(), this.lastApplePosition); //** Todo : enemy tail logic
        ...
        if (i == 0) {
          switch (this.direction) {
            case "right":
              if (s.x > this.canvas.width) s.x = 0;else s.x += this.size;
              break;

            case "down":
              if (s.y > this.canvas.height) s.y = 0;else s.y += this.size;
              break;

            case "left":
              if (s.x < 0) s.x = this.xEnd;else s.x -= this.size;
              break;
    ...
    key: "joystickControl",
    value: function joystickControl(newDirection) {
    ...
    value: function appleBiteScore() {
      ...
      if (this.combo.value == 8) {
        ...
        this.timer = setTimeout(function () {
          ...
          _this5.immortal = false;
          clearTimeout(_this5.timer);
        }, 20000);
      }

      this.trophy.innerText = this.score; // console.log(this.trophy.getAttribute("data-badge"));
    }
  }, {
    key: "resize",
    ...
    value: function applePosition() {
      return {
        x: Math.round(this.random(this.appleSize, this.canvas.width - this.appleSize) / this.appleSize) * this.appleSize,
...
},{"./snake":"snake.ts","./gameEffects":"gameEffects.ts"}],"node_modules/parseuri/index.js":[function(require,module,exports) {
/**
 * Parses an URI
 *
...
},{"ms":"node_modules/socket.io-client/node_modules/ms/index.js"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"./common":"node_modules/socket.io-client/node_modules/debug/src/common.js","process":"../../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/socket.io-client/lib/url.js":[function(require,module,exports) {
...
},{"./common":"node_modules/engine.io-client/node_modules/debug/src/common.js","process":"../../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/engine.io-client/lib/transports/polling.js":[function(require,module,exports) {
/**
 * Module dependencies.
 */
...
},{"./url":"node_modules/socket.io-client/lib/url.js","socket.io-parser":"node_modules/socket.io-client/node_modules/socket.io-parser/index.js","./manager":"node_modules/socket.io-client/lib/manager.js","debug":"node_modules/socket.io-client/node_modules/debug/src/browser.js","./socket":"node_modules/socket.io-client/lib/socket.js"}],"ConnectionManager.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(ConnectionManager, [{
    ...
    value: function connect(url) {
      this.conn = socket_io_client_1.default(url);
      this.conn.emit('init', 'client-ready');
      this.conn.on('init', function (msg) {
...
},{"bulma/css/bulma.css":"node_modules/bulma/css/bulma.css","bulma-badge/dist/css/bulma-badge.min.css":"node_modules/bulma-badge/dist/css/bulma-badge.min.css","bulma-tooltip/dist/css/bulma-tooltip.min.css":"node_modules/bulma-tooltip/dist/css/bulma-tooltip.min.css","typeface-press-start-2p":"node_modules/typeface-press-start-2p/index.css","./node_modules/nes.css/css/nes.css":"node_modules/nes.css/css/nes.css","typeface-orbitron":"node_modules/typeface-orbitron/index.css","./node_modules/animate.css/animate.css":"node_modules/animate.css/animate.css","nipplejs":"node_modules/nipplejs/dist/nipplejs.js","./scss/main.scss":"scss/main.scss","./game":"game.ts","./ConnectionManager":"ConnectionManager.ts","./utils":"utils.ts"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "64777" + '/');
