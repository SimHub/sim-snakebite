...
},{"_css_loader":"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/bulma-divider/dist/css/bulma-divider.min.css":[function(require,module,exports) {
...
},{"process":"../../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/clipboard/dist/clipboard.js":[function(require,module,exports) {
var define;
/*!
 * clipboard.js v2.0.4
...
},{}],"node_modules/typeface-orbitron/index.css":[function(require,module,exports) {
...
require("bulma-divider/dist/css/bulma-divider.min.css");
...
var _clipboard = _interopRequireDefault(require("./node_modules/clipboard/dist/clipboard.js"));
...
(0, _jquery.default)("#urlCodeLengthInfo").html(codeUrlLength);

function listener(event) {
  var val = joinRoomCode.value;

  if (val.length >= codeUrlLength) {
    joinRoom.removeAttribute("disabled");
    (0, _jquery.default)("#joinCheckIcon").removeClass().addClass("far fa-check-circle custom-icon").css("color", "green");
    joinRoom.addEventListener("click", function (e) {
      e.preventDefault();

      if (newRandomCode.value) {
        location.assign("".concat(_utils.default.http).concat(_utils.default.ip, ":").concat(_utils.default.port, "/").concat(val, "\n"));
      }
    });
  } else {
    console.log("NOOP");
...
(0, _jquery.default)(".tablinks").on("click", function (e) {
  var target = e.target;
  ...
  (0, _jquery.default)(".tablinks").each(function (key, item) {
    (0, _jquery.default)(item).removeClass("is-active");
    (0, _jquery.default)(target).parent().addClass("is-active");
    var dataId = (0, _jquery.default)(target).parent().data("link");
    console.log(dataId);
    (0, _jquery.default)(".tabcontent").each(function (k, i) {
      (0, _jquery.default)(i).css("display", "none");
    });
    (0, _jquery.default)("#".concat(dataId)).css("display", "block");
  });
}); //// CLIPBOARD ////

var clipboard = new _clipboard.default(btn);
...
function clip(e) {
  console.log(e);
  (0, _jquery.default)("#btn").removeClass("far fa-copy").addClass("fas fa-copy");
  (0, _jquery.default)("#joinRoomCode").data("tooltip", "copied");
  (0, _jquery.default)("#copiedPopup").css("display", "block");
  setTimeout(function () {
    (0, _jquery.default)("#copiedPopup").css("display", "none");
  }, 2000);
}
/* ///// START GAME //// */
...
},{"bulma/css/bulma.css":"node_modules/bulma/css/bulma.css","bulma-divider/dist/css/bulma-divider.min.css":"node_modules/bulma-divider/dist/css/bulma-divider.min.css","bulma-tooltip/dist/css/bulma-tooltip.min.css":"node_modules/bulma-tooltip/dist/css/bulma-tooltip.min.css","typeface-press-start-2p":"node_modules/typeface-press-start-2p/index.css","./node_modules/nes.css/css/nes.css":"node_modules/nes.css/css/nes.css","jquery":"node_modules/jquery/dist/jquery.js","./node_modules/clipboard/dist/clipboard.js":"node_modules/clipboard/dist/clipboard.js","typeface-orbitron":"node_modules/typeface-orbitron/index.css","./utils":"utils.ts"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","start.js"], null)
